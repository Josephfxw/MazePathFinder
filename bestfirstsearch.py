...
# A* searcj function
def best_first_search(graph, start, goal): # here the goal must be 'M', since we already stored the heuristic costs
...
reconstruct_path(best_first_search(example_graph, 'A','M'),'A','M')
