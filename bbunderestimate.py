#Branch and Bound with Underestimate
...
# A* searcj function
def bb_underestimate_search(graph, start, goal): # here the goal must be 'M', since we already stored the heuristic costs
...
reconstruct_path(bb_underestimate_search(example_graph, 'A','M'),'A','M')
